        ...
        Column(
          ...
          children: [
            RichText(
                text: TextSpan(
                    children: <TextSpan>[
                      TextSpan(text: username, style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black87)),
                      TextSpan(text: " ", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black87)),
                      TextSpan(text: text, style: TextStyle(color: Colors.black87)),
                    ])),
            if (dateTime != null)
              Text(dateTime.toIso8601String(), style: TextStyle(color: Colors.grey[400]),)
          ],
        ),
      ],
    );
